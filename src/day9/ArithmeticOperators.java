...
public class ArithmeticOperators {
    public static void main(String[] args) {
        ...
        (İkili Operatörlerdir) iki operant alıyorlar.
...
//        System.out.println("Toplam = "+toplam);
        ...
        //TASK: x, y ve z değişkenleri tanımlacaktır. Sırasıyla 12, 10 ve x+y atamaları yapınız. Daha sonra sout.
...
//        YANLIŞ SONUÇ İLERİDE AYRINTILARINI GÖRECEĞİZ!
